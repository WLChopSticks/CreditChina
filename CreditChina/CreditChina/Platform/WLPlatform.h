...
#define RedStyle [UIColor redColor]
#define WhiteStyle [UIColor whiteColor]

//灰色背景
#define LightGrayBackground [UIColor colorWithRed:251/255.0 green:249/255.0 blue:250/255.0 alpha:1.0]
#define RedBackground [UIColor colorWithRed:255/255.0 green:0/255.0 blue:0/255.0 alpha:1.0]
